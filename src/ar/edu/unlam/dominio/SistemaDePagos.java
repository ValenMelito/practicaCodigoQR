...
public class SistemaDePagos {
	...
	/***
	 * Genera un nuevo c�digo QR para una nueva compra. El mismo se debe generar de manera aleatoria, pero no puede repetirse, es decir se debe verificar que no se haya generado para otra compra anterior.
	 * Su valor est� dado entre  1000 y el valor m�ximo que soporta el tipo de dato Long
	 * 
